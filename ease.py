...
class Ease:
    ...
    @staticmethod
    def in_out_cubic(x):
        return 4 * math.pow(x, 3) if x < 0.5 else \
    ...
    @staticmethod
    def in_out_circ(x):
        return (1 - math.sqrt(1 - math.pow(2 * x, 2))) / 2 if x < 0.5 else \
    ...
    @staticmethod
    def in_out_bounce(x):
        return (1 - Ease.out_bounce(1 - 2 * x)) / 2 if x < 0.5 else \
            (1 + Ease.out_bounce(2 * x - 1)) / 2
